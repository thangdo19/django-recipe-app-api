...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_basic_recipe(self):
        ...
        for key in payload.keys():
            # getattr equals dynamic take array element
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'Pho Bo Tai', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Recipe 1')
        recipe2 = sample_recipe(user=self.user, title='Recipe 2')
        ingredient1 = sample_ingredient(user=self.user, name='Tag 1')
        ingredient2 = sample_ingredient(user=self.user, name='Tag 2')
